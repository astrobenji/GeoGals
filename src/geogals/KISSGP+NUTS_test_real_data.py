...
N_SAMPLES = 10 
# Will try 480 for real runs
# Probably 400 samples + 80 burn-in, but we want control to be able to discard these later

def pyro_model(x, y):
    with gpytorch.settings.fast_computations(False, True, True):
    # Or try as an alternative
    # with gpytorch.settings.fast_computations(False, True, True):
